...
CREATE INDEX IF NOT EXISTS idx_tickets_org_status ON helpdesk_tickets (org_id, status);
CREATE INDEX IF NOT EXISTS idx_tickets_org_created ON helpdesk_tickets (org_id, created_at);
CREATE INDEX IF NOT EXISTS idx_categories_dept_active ON helpdesk_categories (department, is_active);
