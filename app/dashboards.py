...
def super_admin_dashboard():
    ...
    return render_template(
        ...
        primary_cta=("management.category_assignments", "Category & CA Management"),
...
def admin_dashboard():
    ...
    return render_template(
        ...
        page_description="Manage categories, CA assignments, and monitor ticket activity.",
        highlight_title="Recent users",
        highlight_note="Admins manage roles and categories. Ticket assignment is automatic via category-to-CA mapping.",
        primary_cta=("management.category_assignments", "Category & CA Management"),
...
def hod_dashboard():
    ...
    return render_template(
        ...
        highlight_note="HOD manages CAs by mapping categories to Concerned Authorities.",
        primary_cta=("management.management_category", "Manage CA Mapping"),
